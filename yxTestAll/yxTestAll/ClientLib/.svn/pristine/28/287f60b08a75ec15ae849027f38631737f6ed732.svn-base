...
#define MD52IMPL(md5ref)     (MD5_impl_ref)md5ref
...
} MD5_impl, *MD5_impl_ref;





static void MD5_memcpy (md5_POINTER output, md5_POINTER input, size_t len);
static void MD5Transform (md5_UINT4 state[4], unsigned char block[64]);
static void Encode (unsigned char *output, md5_UINT4 *input, size_t len);
static void MD5_memset (md5_POINTER output, int value, size_t len);
static void Decode (md5_UINT4 *output, unsigned char *input, size_t len);
...
MD5Ref MD5_Init ()
{
    MD5_impl_ref context = (MD5_impl_ref)MALLOC(sizeof(MD5_impl));
...
void MD5_Release (unsigned char digest[16], MD5Ref* md5ref)
{
    ...
    MD5_impl_ref context = MD52IMPL(*md5ref);
...
void MD5_String (char *string,unsigned char digest[16])
{
    ...
    MD5Ref md5ref = MD5_Init ();
    MD5_Update (md5ref, (unsigned char *)string, len);
    MD5_Release (digest, &md5ref);
}
